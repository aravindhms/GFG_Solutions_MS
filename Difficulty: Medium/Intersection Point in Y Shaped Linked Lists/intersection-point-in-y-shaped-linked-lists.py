...
def intersetPoint(head1,head2):
        ...
        # Traverse the linked lists; if one pointer reaches the end, switch to the other list
        while ptr1 != ptr2:
            ptr1 = ptr1.next if ptr1 else head2
            ptr2 = ptr2.next if ptr2 else head1

        # If they intersect, ptr1 (or ptr2) will point to the intersection node; if not, it will be None
